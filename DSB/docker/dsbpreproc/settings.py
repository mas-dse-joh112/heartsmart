BASE_DIR = "./data/"
BASE_PREPROCESS_DIR = "./preproc/"
BASE_PREPROCESSEDCSV_DIR = BASE_PREPROCESS_DIR + "csv/"
BASE_PREPROCESSEDIMAGES_DIR = BASE_PREPROCESS_DIR + "images/"
BASE_TRAIN_SEGMENT_DIR = BASE_PREPROCESS_DIR + "data_segmenter_trainset/"
PATIENT_PRED_DIR = BASE_PREPROCESS_DIR + "data_patient_predictions/"
