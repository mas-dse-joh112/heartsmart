...
SCDimgpathT = BASE_DIR + SOURCE + "/challenge_training/" 
SCDimgpathV = BASE_DIR + SOURCE + "/challenge_validation/"


class ContourVolume(object):
    def _init_(self, arg):
        self.arg = arg
        print (self.arg)
    ...
    def patientVolume(patient_path):
            print ('Make it')
            for root,_, files in os.walk(patient_path, norm = None):
