...
#             plt.show()
    ...
    def dump_and_sort(self):
        ...
        new_path = '/masvol/output/{0}/volume/1/3combined_1_3_0_176_aug_drop_dice/{1}_{2}_{3}.json'.format(self.file_source,self.source_type,str(self.patient),self.image_size)
    ...
    def do_predict(self):
        ...
        pred_file = "{0}/{1}/combined_1_3_0_176_aug_drop_dice_predict/{2}_{3}_{4}_predictions.npy".format(self.test_source_path,self.data_source,self.file_source,self.patient,self.image_size)
        np.save(pred_file, self.predictions)
        pred2 = np.round(self.predictions)
        pred_round_file = "{0}/{1}/combined_1_3_0_176_aug_drop_dice_predict/{2}_{3}_{4}_pred_round.npy".format(self.test_source_path,self.data_source,self.file_source,self.patient,self.image_size)
        np.save(pred_round_file, pred2)
        ts_norm_file = "{0}/{1}/combined_1_3_0_176_aug_drop_dice_predict/{2}_{3}_{4}_ts_norm.npy".format(self.test_source_path,self.data_source,self.file_source,self.patient,self.image_size)
...
if __name__ == "__main__":
    ...
    model_file = "/masvol/heartsmart/unet_model/baseline/results/combined_1_3_0_{0}_aug_drop_dice.hdf5".format(image_size)
