...
#             plt.show()
    ...
    def fourD_add1(self):
        ...
        #pred_path = os.path.dirname(pred_file_CR)

        #if not os.path.exists(pred_path):
        #    os.makedirs(pred_path)

        np.save(pred_file_CR, self.pred_round)                     
    ...
    def dump_and_sort(self):
        ...
        new_path = '/masvol/output/{0}/volume/{1}/{2}/{3}_{4}_{5}.json'.format(self.file_source,method,volume_path,self.source,str(self.patient),self.image_size)
...
#             print (min_max)
    ...
    def do_predict(self):
        ...
        #pred_round_file = "{0}/{1}/{2}_cr/{3}_{4}_{5}_pred_round.npy".format(self.test_source_path,self.data_source,predict_path,self.file_source,self.patient,self.image_size)
        ...
        #ts_norm_file = "{0}/{1}/{2}_cr/{3}_{4}_{5}_ts_norm.npy".format(self.test_source_path,self.data_source,predict_path,self.file_source,self.patient,self.image_size)
...
if __name__ == "__main__":
    ...
    image_size, source, source_type, method, Type, hdf5_path, predict_path, volume_path = arg
    ...
    mm.volume_path = volume_path
    mm.source_type = source_type # train, test, validate, or roi
    mm.source = source # train, test, validate
    ...
    mm.predict_path = predict_path

    inputpath = "/masvol/data/{0}/{1}/*".format(mm.file_source, mm.source)
#     inputpath = "/masvol/output/{0}/norm/{1}/{2}/{3}/data/*".format(mm.file_source,method,Type,mm.source_type)
    ...
    for i in glob.glob(inputpath):
        ...
        mm.image_one_file = "{0}/{1}/{2}/{3}_{4}_{5}_one_count.json".format(mm.test_source_path, mm.data_source, mm.predict_path, mm.file_source, mm.patient, mm.image_size)
