...
class myUnet(object):
    ...
    def load_data(self, train_data, test_data):
        print('-'*30)
        print("loading data")
        self.train_images, self.train_labels = load_images_and_labels2(train_data, normalize= True)
        self.test_images, self.test_labels = load_images_and_labels2(test_data, normalize= True)       
